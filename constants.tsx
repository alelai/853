...
export const TRANSLATIONS: TranslationData = {
  ...
  innovation: {
    ...
    future: {
      headline: { en: 'Cross-Industry Synergy & Collaborative Vision', zh_tw: '跨界協同與全球合作願景', zh_cn: '跨界协同与全球合作愿景' },
      paragraph: {
  ...
  footer: {
    ...
    contactList: [
      { label: { en: '濠概醫療用品有限公司 / 澳門853口罩廠', zh_tw: '濠概醫療用品有限公司 / 澳門853口罩廠', zh_cn: '濠概医疗用品有限公司 / 澳门853口罩厂' }, value: '+853 2821 6012' },
      { label: { en: 'Sales E-mail', zh_tw: 'Sales E-mail', zh_cn: 'Sales E-mail' }, value: 'sales@macaufacture.com' },
      { label: { en: '澳門853藥房有限公司 / 健康薈藥房', zh_tw: '澳門853藥房有限公司 / 健康薈藥房', zh_cn: '澳门853药房有限公司 / 健康荟药房' }, value: '+853 2821 6013' },
      { label: { en: '澳門853國際生物醫藥科技有限公司 / 澳科生技大健康製造廠', zh_tw: '澳門853國際生物醫藥科技有限公司 / 澳科生技大健康製造廠', zh_cn: '澳门853国际生物医药科技有限公司 / 澳科生技大健康制造厂' }, value: '+853 2821 6014' },
      { label: { en: 'Enquiry E-mail', zh_tw: 'Enquiry E-mail', zh_cn: 'Enquiry E-mail' }, value: 'enquiry@macaufacture.com' },
      { label: { en: '陳小姐 (業務聯繫)', zh_tw: '陳小姐 (業務聯繫)', zh_cn: '陈小姐 (业务联系)' }, value: '+853 6203 3133' },
      { label: { en: '黃小姐 (業務聯繫)', zh_tw: '黃小姐 (業務聯繫)', zh_cn: '黄小姐 (业务联系)' }, value: '+853 6881 6853' },
      { label: { en: 'Fax 號碼', zh_tw: 'Fax 號碼', zh_cn: 'Fax 号码' }, value: '+853 2875 3044' },
    ]
  },
  milestone: {
    title: { en: 'Historical Trajectory', zh_tw: '企業發展歷程', zh_cn: '企业发展历程' },
    items: [
      {
        date: { en: '2024.07', zh_tw: '2024年7月', zh_cn: '2024年7月' },
        text: { en: 'Strategic project approval with MOP 3M+ initial capital injection.', zh_tw: '獲特區政府戰略項目批准，投入超三百萬澳門元啟動研發。', zh_cn: '获特区政府战略项目批准，投入超三百万澳门元启动研发。' }
      },
      {
        date: { en: '2025.09', zh_tw: '2025年9月', zh_cn: '2025年9月' },
        text: { en: 'Official Industrial License secured, establishing high-end manufacturing capacity.', zh_tw: '正式獲頒工業准照，建立澳門首條專業自動化膏貼生產線。', zh_cn: '正式获颁工业准照，建立澳门首条专业自动化膏贴生产线。' }
      }
    ]
  },
  advantages: {
    title: { en: 'Unrivaled Industrial Advantages', zh_tw: '核心產業競爭優勢', zh_cn: '核心产业竞争优势' },
    subtitle: { en: 'Synthesizing Policy, Location, and Technology', zh_tw: '政策優勢、地理區位與技術實力的完美融合', zh_cn: '政策优势、地理区位与技术实力的完美融合' },
    items: [
      {
        highlight: { en: 'DSEDT', zh_tw: '准照資質', zh_cn: '准照资质' },
        title: { en: 'Certified Manufacturing', zh_tw: '合規工業製造', zh_cn: '合规工业制造' },
        desc: { en: 'Holders of official Macau industrial manufacturing licenses ensuring international compliance.', zh_tw: '持有政府頒發的工業准照，是澳門極少數具備規模化製造能力的生物醫藥企業。', zh_cn: '持有政府颁发的工业准照，是澳门极少数具备规模化制造能力的生物医药企业。' }
      }
    ]
  },
  dosageForms: {
    title: { en: 'Dosage Form R&D', zh_tw: '劑型研發與創新', zh_cn: '剂型研发与创新' },
    subtitle: { en: 'Specialized focus on patches and functional healthcare solutions.', zh_tw: '專注於高分子醫藥貼劑與功能性保健品的深度開發。', zh_cn: '专注于高分子医药贴剂与功能性保健品的深度开发。' },
    items: [
      {
        id: 'plaster',
        name: { en: 'Medical Plasters', zh_tw: '專業醫藥膏貼', zh_cn: '专业医药膏贴' },
        desc: { en: 'Utilizing TPU and PP materials for superior athletic and medical recovery.', zh_tw: '結合高分子材料技術，提供具備極佳透氣性與貼合度的專業級膏貼。', zh_cn: '结合高分子材料技术，提供具备极佳透气性与贴合度的专业级膏贴。' },
        specs: [
          { en: 'Breathable TPU', zh_tw: 'TPU 透氣材料', zh_cn: 'TPU 透气材料' },
          { en: 'Extended Release', zh_tw: '長效緩釋技術', zh_cn: '长效缓释技术' }
        ]
      }
    ]
  },
  caseStudies: {
    title: { en: 'Strategic Success Stories', zh_tw: '戰略成功案例', zh_cn: '战略成功案例' },
    items: [
      {
        type: { en: 'Industrial OEM', zh_tw: '工業代工服務', zh_cn: '工业代工服务' },
        title: { en: 'GBA Pharmacy Network', zh_tw: '全澳及大灣區藥房供應網絡', zh_cn: '全澳及大湾区药房供应网络' },
        desc: { en: 'Establishing a robust distribution and OEM network covering 367 pharmacies in Macau alone.', zh_tw: '為全澳 367 家藥房提供定制化 OEM 服務，助力傳統品牌實現技術標籤轉化。', zh_cn: '为全澳 367 家药房提供定制化 OEM 服务，助力传统品牌实现技术标签转化。' },
        points: [
          { en: 'Macau Manufacturing', zh_tw: '澳門製造標籤', zh_cn: '澳门制造标签' },
          { en: 'Rapid Iteration', zh_tw: '產品快速迭代', zh_cn: '产品快速迭代' }
        ],
  ...
  hengqin: {
    ...
    sections: [
      ...
      {
        title: { en: 'GMP Production Ecosystem', zh_tw: 'GMP 標准生產體系', zh_cn: 'GMP 标准生产体系' },
        desc: { en: 'Operating state-of-the-art facilities for health foods and medical device manufacturing.', zh_tw: '建立符合 GMP 標準的現代化車間，專注於保健食品及第二類醫療器械的規模化生產。', zh_cn: '建立符合 GMP 标准的现代化车间，专注于保健食品及第二类医疗器械的规模化生产。' },
        list: [
          { en: 'Global Supply Logistics', zh_tw: '全球市場物流分發', zh_cn: '全球市场物流分发' },
          { en: 'Quality Assurance Control', zh_tw: '嚴苛品質安全監控', zh_cn: '严苛品质安全监控' }
        ]
      }
    ]
  },
  vision: {
    title: { en: 'Our Vision & Corporate Mission', zh_tw: '企業願景與核心使命', zh_cn: '企业愿景与核心使命' },
    items: [
      {
